...
python -m pytest tests/integrador/test_suite_integrador.py -v -n 2 --cov=helpers --cov=pages --cov-report=term-missing --cov-report=html:coverage-report --alluredir=reports/allure-results --clean-alluredir

-Ejecucion con Workers: (n 2 indica la cantidad de workers)
python -m pytest tests/integrador/test_suite_integrador.py -v -n 2

-Comando ejecución de cobertura de proyecto
python -m pytest tests/integrador/test_suite_integrador.py --cov=helpers --cov=pages --cov-report=term-missing --cov-report=html:coverage-report

-Levantar reporte de cobertura html
start coverage-report/index.html

-Generar Reporte Allure
python -m pytest tests/integrador/test_suite_integrador.py --alluredir=reports/allure-results --clean-alluredir
python -m pytest tests/integrador/test_suite_integrador.py --alluredir=reports/allure-results
